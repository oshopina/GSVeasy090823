...
load_graftm_gene_count(s_folder = S_folder, c_folder = C_folder,
...
# pdf("Figures/C_alpha_plots.pdf")
# for (plot in alpha_plots$C_per_million) {
#   print(plot)
# }
# dev.off()
...
qPCR = qPCR[qPCR$SampleID %in% rownames(GSV_gene_count_list$C_per_million),]
